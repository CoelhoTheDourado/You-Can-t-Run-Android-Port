function onCreate()
	setPropertyFromClass("openfl.Lib", "application.window.title", "FUN IS INFINITE | " .. (songName))
end
function onDestroy()
	setPropertyFromClass("openfl.Lib", "application.window.title", "FUN IS INFINITE")
end
